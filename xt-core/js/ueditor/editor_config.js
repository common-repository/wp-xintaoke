...
(function() {
	 ...
	 */
	var tmp = location.protocol.indexOf("file") == -1
			? location.pathname
			: location.href;
	...
	window.UEDITOR_CONFIG = {
		...
		toolbars : [['fullscreen', 'source', '|', 'undo', 'redo', '|', 'bold',
				...
				'justifyjustify', '|', 'link', 'unlink', 'anchor', '|',
				'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
				'insertimage', 'emotion', 'insertvideo', 'music', 'map',
				'gmap', 'insertframe', 'webapp', 'background', '|',
		...
		,
		webAppKey : "cigdyj66D6QgpHelsHnwo316"
