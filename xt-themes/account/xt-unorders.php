...
?>
<div id="X_Account-Unorder">
    <div class="row-fluid">
        <div class="span7">
            <div class="form-inline xt-account-datepicker">
                <input type="text" name="sd" class="input-medium" value="<?php echo date('Y-m-d', strtotime("-3 month")); ?>" id="X_Account-Unorder-StartDate"> 至 
                <input type="text" name="ed" class="input-medium" value="<?php echo $_currentDate ?>" id="X_Account-Unorder-EndDate">
                <button class="btn" id="X_Account-Unorder-Date-Submit" >搜索</button>
            </div>
        </div>
        <div class="span5" id="X_Account-Unorder-Date-Shortcut">
        ...
        <ul class="span12 nav nav-pills" id="X_Account-Unorder-Type" style="margin-left:0px;">
        ...
        <div class="span12 xt-account-list" id="X_Account-Unorder-List" style="margin-left:0px;">
        </div>	
    </div>
</div>