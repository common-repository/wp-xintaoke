...
<div class="clear" style="margin-top:10px;">
    <p class="search-box">
        <label class="screen-reader-text" for="filter-search-input">搜索拍拍交易:</label>
        <input type="search" id="filter-search-input" name="s" value="<?php echo $s; ?>">
        <input type="button" name="" id="filter-search-submit" class="button" value="搜索拍拍交易">
    </p>    
</div>
...
<table class="wp-list-table widefat fixed tags" cellspacing="0">
    <thead>
        <tr>
            <th class="manage-column" style="width: 80px"><?php xt_admin_help_link('fanxian_paipai')?><span>交易号</span></th>
    ...
    <tfoot>
        <tr>
            <th class="manage-column" style="width: 80px"><span>交易号</span></th>
            <th class="manage-column" style="width: 120px"><span>交易时间</span></th>
            <th class="manage-column"><span>商品</span></th>
            <th class="manage-column" style="width: 60px"><span>实际付款</span></th>
            <th class="manage-column" style="width: 60px"><span>成交件数</span></th>
    ...
    jQuery(document).ready(function($) {
        ...
        $('#X_Fanxian-Order-Get-Submit').click(function(){
            ...
            $.ajax({
                ...
                data : {
                    action : 'xt_admin_ajax_report_paipai',
